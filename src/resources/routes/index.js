module.exports.chefRoutes = require('./chefRoutes');
module.exports.customerRoutes = require('./customerRoutes');
module.exports.managerRoutes = require('./managerRoutes');
module.exports.waiterRoutes = require('./waiterRoutes');
